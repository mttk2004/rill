...
const ArtistCreate = ({ countries }: PageProps) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post('/admin/artists', submitData, {
        headers: {
      ...
      if (response.data.success) {
        toast.success(response.data.message || 'Tạo nghệ sĩ mới thành công');
      ...
      if (
        ...
        toast.error(
          responseData.message || 'Có lỗi xảy ra khi tạo nghệ sĩ'
        );
      } else {
        toast.error('Có lỗi xảy ra khi tạo nghệ sĩ');
      }
    } finally {
      setIsSaving(false);
    }
        ...
        <div className="container mx-auto py-6 px-4">
          ...
          <div className="mb-6">
            <div className="flex items-center gap-4 mb-2">
              ...
              <h1 className="text-3xl font-bold">Thêm nghệ sĩ mới</h1>
            </div>
            <p className="text-muted-foreground ml-14">
              Nhập thông tin chi tiết để tạo nghệ sĩ mới
            </p>
          </div>
