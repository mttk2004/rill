...
const Checkout = () => {
  ...
  const [paymentMethod, setPaymentMethod] = useState('cod' as 'cod' | 'vnpay');
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <div className="space-y-8 lg:col-span-7">
            ...
            <div className="rounded-xl bg-white p-6 shadow-sm">
              ...
              <div className="space-y-3">
                <label className={`flex cursor-pointer items-center gap-4 rounded-lg border p-4 transition-all ${paymentMethod === 'cod' ? 'border-primary bg-primary/5 ring-1 ring-primary' : 'border-gray-200'}`}>
                   <input 
                    type="radio" 
                    name="payment" 
                ...
                <label className={`flex cursor-pointer items-center gap-4 rounded-lg border p-4 transition-all ${paymentMethod === 'vnpay' ? 'border-primary bg-primary/5 ring-1 ring-primary' : 'border-gray-200'}`}>
                   <input 
                    type="radio" 
                    name="payment" 
                    className="text-primary focus:ring-primary"
