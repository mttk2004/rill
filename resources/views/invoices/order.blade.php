            ...
            <table>
                <tr>
                    <td>
                        ...
                        <strong>Địa chỉ:</strong> {{ $order->shipping_address['address_line_1'] }}, {{ $order->shipping_address['ward'] }}, {{ $order->shipping_address['district'] }}, {{ $order->shipping_address['city'] }}<br>
